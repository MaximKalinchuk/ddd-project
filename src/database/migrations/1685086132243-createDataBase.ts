...
export class createDataBase1685086132243 implements MigrationInterface {
    name = 'createDataBase1685086132243'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "posts" ("id" uuid NOT NULL, "created_At" TIMESTAMP DEFAULT now(), "updated_At" TIMESTAMP DEFAULT now(), "deleted_At" TIMESTAMP, "img" character varying, "title" character varying NOT NULL, "description" character varying NOT NULL, "userId" uuid, CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
